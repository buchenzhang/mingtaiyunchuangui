<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="实际出货数量" prop="deliveredQuantity">
        <el-input
          v-model="queryParams.deliveredQuantity"
          placeholder="请输入实际出货数量"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="含税单价(元)" prop="unitPriceWithTax">
        <el-input
          v-model="queryParams.unitPriceWithTax"
          placeholder="请输入含税单价(元)"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="salesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="实际出货数量" align="center" prop="deliveredQuantity" />
      <el-table-column label="含税单价(元)" align="center" prop="unitPriceWithTax" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="实际出货数量" prop="deliveredQuantity">
          <el-input v-model="form.deliveredQuantity" placeholder="请输入实际出货数量" />
        </el-form-item>
        <el-form-item label="含税单价(元)" prop="unitPriceWithTax">
          <el-input v-model="form.unitPriceWithTax" placeholder="请输入含税单价(元)" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除销售记录编号为"' + ids + '"的数据项？').then(function() {
        return delSales(ids);
      }).then(() => {
        this.getList();
