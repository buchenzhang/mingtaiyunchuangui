...
<!--    </el-row>-->
    ...
    <el-table v-loading="loading" :data="resultList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="客户编码" align="center" prop="customerName" />
      <el-table-column label="物料代号" align="center" prop="materialCode" />
      <el-table-column label="产品名称" align="center" prop="productName" />
      <el-table-column label="审计结果" align="center" prop="auditStatus" />
...
<!--      </el-table-column>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="客户编码" prop="customerName">
          <el-input v-model="form.customerName" placeholder="请输入客户编码" />
        </el-form-item>
        <el-form-item label="物料代号" prop="materialCode">
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除审计结果编号为"' + ids + '"的数据项？').then(function() {
