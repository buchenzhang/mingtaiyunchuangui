<template>
  <div class="app-container">
    <!--    <el-card>-->
    <!--      <h1 style="text-align: center; font-size: 40px">生产看板</h1>-->
    <!--    </el-card>-->
...
<!--        <el-form-item label="后段" prop="last">-->
<!--          <el-select v-model="form.last" placeholder="请选择下拉选择" clearable :style="{width: '100%'}">-->
<!--            <el-option v-for="(item, index) in LsatOptions" :key="index" :label="item.label"-->
<!--                       :value="item.value" :disabled="item.disabled"></el-option>-->
<!--          </el-select>-->
<!--        </el-form-item>-->
